...
output_dir = os.path.join(output_dir_top, 'images', f'{datetime}-{chosen_bead_size}nm')
...
rotational_diffusion_time = beads_nm[chosen_bead_size]  # choose from beads_nm, which one to animate
