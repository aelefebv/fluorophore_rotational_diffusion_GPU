...
rotational_diffusion_times = [2500, 25000, 250000]  # these get multiplied by pi during the simulation
...
csv_subdir_path = os.path.join('data', f'{datetime}_factor10.csv')
